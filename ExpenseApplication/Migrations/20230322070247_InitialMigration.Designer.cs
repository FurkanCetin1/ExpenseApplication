...
namespace ExpenseApplication.Migrations
{
    ...
    [Migration("20230322070247_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExpenseApplication.Models.ExpenseAction", b =>
                {
                    b.Property<int>("ExpenseActionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("ExpenseActionID");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ExpenseActionId"));
                    ...
                    b.HasKey("ExpenseActionId")
                        .HasName("PK__ExpenseA__4C4C1B723FD4F5E1");

                    b.HasIndex("ExpenseId");

                    b.HasIndex("UserId");

                    b.HasIndex(new[] { "StatusId" }, "UQ_StatusID")
                        .IsUnique();

                    b.ToTable("ExpenseActions");
                });
            ...
            modelBuilder.Entity("ExpenseApplication.Models.ExpenseAction", b =>
                {
                    b.HasOne("ExpenseApplication.Models.Expense", "Expense")
                        .WithMany("ExpenseActions")
                        .HasForeignKey("ExpenseId")
                        .IsRequired()
                        .HasConstraintName("FK__ExpenseAc__Expen__44FF419A");

                    b.HasOne("ExpenseApplication.Models.User", "User")
                        .WithMany("ExpenseActions")
                        .HasForeignKey("UserId")
                        .IsRequired()
                        .HasConstraintName("FK__ExpenseAc__UserI__45F365D3");
            ...
            modelBuilder.Entity("ExpenseApplication.Models.ExpenseForm", b =>
                {
                    b.HasOne("ExpenseApplication.Models.ExpenseAction", "Status")
                        .WithMany("ExpenseForms")
                        .HasForeignKey("StatusId")
                        .HasPrincipalKey("StatusId")
                        .HasConstraintName("FK__ExpenseFo__Statu__6754599E");
            ...
            modelBuilder.Entity("ExpenseApplication.Models.ExpenseHistory", b =>
                {
                    ...
                    b.HasOne("ExpenseApplication.Models.ExpenseAction", "Status")
                        ...
                        .HasForeignKey("StatusId")
                        .HasPrincipalKey("StatusId")
                        .HasConstraintName("FK_ExpenseHistory_StatusID");
